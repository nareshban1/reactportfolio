        ...
        <div className="timeline" id="timeline">
            ...
            <div className="timelinecontent">
                <div className="container left">
                    ...
                    <p className="desc">I am currently working part time as a team leader in cloudfactory. I have the responsibility 
                ...
                <div className="container right">
                    ...
                    <p className="desc">I have completed my Bachelors on july 2020 with First class certification from Herald college. Since the college was 
                ...
                <div className="container right">
                    ...
                    <p className="desc">I completed my SLC with a distinction from Manakamana English Secondary School. This is when I first learned HTML and CSS and decided that I am going to learn Computer Science for my higher education. </p>
                    </div>
                </div>
            </div>
        </div>
