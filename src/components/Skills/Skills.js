...
const skillsArr =[
  ...
  {name:"Bootstrap", level:"Intermediate",icon:<FaBootstrap />, class:"boot"},
  {name:"Javascript", level:"Basic",icon: <SiJavascript />, class:"javascript"},
  ...
  {name:"Illustration", level:"Beginner",icon:<SiAdobeillustrator/>, class:"ai"},
    ...
    <div className="interest">
      ...
      <div className="skilllist">
        {skillsArr.map(item => (
            ...
            <span className={`cardlogo ${item.class}`}>
              {item.icon}
            </span>
